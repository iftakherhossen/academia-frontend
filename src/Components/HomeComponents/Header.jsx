          ...
          <>
               <div className="min-h-[75vh] container mx-auto text-white flex justify-start items-center">
                    <div className="w-[45%] ml-8">
                         ...
                         <label htmlFor="admissionForm" className="btn mt-7 text-[1rem] rounded bg-pastel-green border-0 text-white px-8 tracking-wider hover:shadow-lg">Apply in 2023 Session &nbsp; <BsArrowRight /></label>
                    </div>
               </div>
